...
// Inverted pyramid: 10 -> 8 -> 6 -> 3 -> 2
const techStack: TechItem[][] = [
  // Row 1 - 10 items (largest) — languages & frontend
  [
  ...
  [
    ...
    { name: "MySQL Workbench", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg", url: "https://mysql.com/products/workbench/" },
  ],
];
